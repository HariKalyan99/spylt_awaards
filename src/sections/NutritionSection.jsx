  ...
  return (
    <section className="nutrition-section">
      <img
        ...
        alt="public/images/slider-dip.png"
        className="w-full object-cover"
      />

      <img
        src="/images/big-img.png"
        alt="/images/big-img.png"
        className="big-img"
      />
      ...
      <div className="flex md:flex-row flex-col justify-between md:px-5 mt-14 md:mt-0">
        ...
        <div className="flex md:justify-center items-center translate-y-5">
          <div className="md:max-w-xs max-w-md">
            <p className="text-lg md:text-right text-balance font-paragraph">
              Milk conatins a wide array of nutrients, including vitamins,
              minerals and proteins. Yet is lactose free
            </p>
          </div>
        </div>
        ...
        <div className="nutrition-box">
          <div className="list-wrapper">
            {lists.map((nutrient, ind) => {
              return (
                <div key={ind} className="relative flex-1 col-center">
                  <div className="">
